...
namespace Arbor.FS
{
    namespace CreateMaps
    {
        ...
        public static class JunctionPoint
        {
                ...
                using (var handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
                {
                    ...
                    try
                    {
                        ...
                        bool result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_SET_REPARSE_POINT,
                            inBuffer, targetDirBytes.Length + 20, IntPtr.Zero, nOutBufferSize: 0, out bytesReturned,
                            IntPtr.Zero);
                ...
                using (var handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
                {
                    ...
                    try
                    {
                        ...
                        bool result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_DELETE_REPARSE_POINT,
                            inBuffer, nInBufferSize: 8, IntPtr.Zero, nOutBufferSize: 0, out bytesReturned, IntPtr.Zero);
            ...
            private static string InternalGetTarget(SafeFileHandle handle)
            {
                ...
                try
                {
                    ...
                    bool result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_GET_REPARSE_POINT,
                        IntPtr.Zero, nInBufferSize: 0, outBuffer, outBufferSize, out bytesReturned, IntPtr.Zero);
            ...
            private static void ThrowLastWin32Error(string message) => throw new IOException(message,
